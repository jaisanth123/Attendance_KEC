      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            onChange={handleChange}
            required
            className="px-3 py-2 pr-10 w-full rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <button
            type="button"
            tabIndex={-1}
            className="absolute right-2 top-9 text-gray-500 transform -translate-y-1/2 hover:text-gray-700"
